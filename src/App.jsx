...
const phases = [
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        details: [
          "Prompt: 'Skriv ett 1500-ords YouTube-manus om [ämne] för en faceless kanal. Strukturera det med: Hook (0–30 sek som skapar nyfikenhet), Value (kärnan av berättelsen, faktatung), Retention (avslut som får dem att titta vidare).'",
          "Granska och godkänn manuset",
          "Kolla att inga förbjudna ord används (Demonetized Words som guide)",
        ],
      },
      {
        ...
        details: [
          ...
          "Välj en röst som matchar din nisch (professionell för finance; mystisk för history)",
          "Klistra in manuset → generera → ladda ner MP3",
          "Tips: Välj 'Stability: 0.5' och 'Clarity: 0.75' för naturligt ljud",
        ],
      },
      {
        title: "STEG 4 — AI-videoediting (InVideo AI)",
        details: [
    ...
    steps: [
      {
        ...
        details: [
          "🔴 YouTube: Tis–Tor kl. 14–16 — YouTube promotar nya videos aktivt dessa tider",
  ...
  },
  {
    ...
    steps: [
      ...
      {
        title: "Testa, förbättra, repetera",
        details: [
                ...
                {phase.steps.map((step, si) => (
                  <div key={si}>
                    <button
                      ...
                      style={{
                        width: "100%",
                        background: activeStep === `${phase.id}-${si}` ? `${phase.color}10` : "#0A0A12",
                    ...
                    >
                      ...
                      <div style={{ flex: 1, fontSize: "13px", fontWeight: "600", color: "#D1CFC9" }}>
                        {step.title}
                      </div>
                      <div style={{
                        color: "#4B5563",
        ...
        <div style={{
          ...
          {weekSchedule.map((item, i) => (
            <div key={i} style={{
              ...
              gap: "12px",
              alignItems: "flex-start",
              marginBottom: i < weekSchedule.length - 1 ? "10px" : 0,
              paddingBottom: i < weekSchedule.length - 1 ? "10px" : 0,
              borderBottom: i < weekSchedule.length - 1 ? "1px solid #141420" : "none",
            }}>
              <div style={{
                minWidth: "38px",
                fontSize: "10px",
